...
class SetupRFIDTotemScreen2 extends StatefulWidget {
  @override
  State<SetupRFIDTotemScreen2> createState() => SetupRFIDTotemScreen2State();
}

class SetupRFIDTotemScreen2State extends State<SetupRFIDTotemScreen2> {
    ...
    return Scaffold(
        ...
        floatingActionButton: Padding(
            ...
            child: FloatingActionButton.extended(
              onPressed: () {
                rfidData.setPassword(_controllerText.text);
                routeState.go('/setup-rfid3');
              },
